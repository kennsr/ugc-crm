...
const FALLBACK_URL = 'https://vdizlbrqxjzssuqtdkhy.supabase.co';
const FALLBACK_ANON_KEY = 'sb_publishable_2-_de_EkwfZ11RzGEW9flQ_OOj0ImiF';
...
export default function LoginPageClient() {
  ...
  const supabase = createSupabaseClient(FALLBACK_URL, FALLBACK_ANON_KEY);
